...
from __future__ import absolute_import, division, print_function  # unknown what this is but everything crashes if i remove it.
...
while True: # Run indefinitely, only ended when we have success or we have a resignation by KeyboardInterrupt.
    try:
        if det:
